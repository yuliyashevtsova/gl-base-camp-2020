...
google.open()
google.search("selenium install ubuntu python")
result = GoogleSearchResultPage(driver)
result.search_click_result()
pypi = PypiPage(driver)
pypi.search("selenium library")
pypi_result = PypiResultPage(driver)
